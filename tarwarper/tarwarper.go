...
// CreateTar creates tarball
func CreateTar(paths []string, tarPath string) error {
...
// ExtarctTar extracts tarball
func ExtarctTar(extractPath, sourcefile string) error {
